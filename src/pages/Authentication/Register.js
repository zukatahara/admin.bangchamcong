...
const Register = () => {
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      stk: Yup.number().required("Please Enter You STK"),
                  ...
                  <CardBody className="p-4">
                    ...
                    <div className="p-2 mt-4">
                      ...
                      >
                        ...
                        <div className="mb-3">
                          <Label htmlFor="fullName" className="form-label">
                            ...
                            <span className="text-danger">
                              (Tên đầy đủ phải trùng với tên trên thẻ ngân hàng.
                              VD: LE LAM QUY)*
                            </span>
                          </Label>
                          <Input
                        ...
                        <div className="mb-3">
                          <Label htmlFor="stk" className="form-label">
                            STK <span className="text-danger">*</span>
                          </Label>
                          <Input
                            name="stk"
                            type="text"
                        ...
                        <div className="mb-3">
                          ...
                          validation.errors.bank_name ? (
                            <FormFeedback type="invalid">
                              <div>{validation.errors.bank_name}</div>
                            </FormFeedback>
                          ) : null}
                        </div>
                        ...
                        <div className="mb-3">
                          ...
                          validation.errors.passwordHash ? (
                            <FormFeedback type="invalid">
                              <div>{validation.errors.passwordHash}</div>
                            </FormFeedback>
                          ) : null}
                        </div>
